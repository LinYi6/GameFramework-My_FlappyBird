...
namespace FlappyBird
{
    ...
    public class ProcedureCheckVersion : ProcedureBase
    {
        ...
        private void RequestVersion()
        {
            ...
            string screenResolution = string.Format("{0} x {1} @ {2}Hz", Screen.currentResolution.width.ToString(), Screen.currentResolution.height.ToString(), Screen.currentResolution.refreshRateRatio.ToString());
